...
function DealsChart() {
    return (
        <div className="bg-gray-50/80 rounded-[32px] p-4 shadow-sm flex flex-col h-full">
            {/* Header */}
            ...
            {/* Chart Area */}
            <div className="flex-1 flex items-end justify-between gap-2 px-1 pb-2 pt-2 min-h-[140px]">
                {/* Behance - Striped */}
                <div className="flex-1 bg-white rounded-2xl shadow-sm relative flex flex-col items-center justify-start pt-3" style={{ height: '55%' }}>
                    <div className="rounded-full w-8 h-8 flex items-center justify-center">
                        <span className="text-[#1769FF] font-black text-base">Bē</span>
                    </div>
                </div>

                {/* Dribbble - White Solid */}
                <div className="flex-1 bg-white rounded-2xl shadow-sm relative flex flex-col items-center justify-start pt-3" style={{ height: '95%' }}>
                    <div className="rounded-full w-8 h-8 flex items-center justify-center">
                        <img src="/icons/dribbble-logo-fill-svgrepo-com.svg" className="w-6 h-6" alt="Dribbble" style={{ filter: 'invert(36%) sepia(93%) saturate(1755%) hue-rotate(317deg) brightness(93%) contrast(93%)' }} />
                    </div>
                </div>
                ...
                {/* Google - White Solid */}
                <div className="flex-1 bg-white rounded-2xl shadow-sm relative flex flex-col items-center justify-start pt-3" style={{ height: '50%' }}>
                ...
                <div className="flex-1 bg-white rounded-2xl shadow-sm relative flex flex-col items-center justify-start pt-3" style={{ height: '35%' }}>
                ...
                {/* Marketplace - Striped */}
                <div className="flex-1 rounded-2xl relative flex flex-col items-center justify-start pt-3" style={{ height: '80%', backgroundImage: 'repeating-linear-gradient(45deg, #ffffff, #ffffff 4px, #f0f0f0 4px, #f0f0f0 8px)' }}>
...
function UserTableHeader() {
    return (
        <div className="grid grid-cols-[minmax(0,1fr)_70px_50px_40px_40px_50px_20px] gap-1 px-1 mb-2 text-[10px] uppercase text-gray-400 font-semibold tracking-wider">
...
function UserRow({ name, image, seed, initial, initialColor, revenue, sales, salesGoal, leads, kpi, wlScore, wlTotal, isActive }) {
    return (
        <div className={`grid grid-cols-[minmax(0,1fr)_70px_50px_40px_40px_50px_20px] items-center px-1 py-1 rounded-2xl border transition-all ${isActive ? 'bg-pink-50/40 border-pink-100 ring-1 ring-pink-100 sticky top-0 z-10' : 'bg-white border-gray-100 hover:border-gray-200 hover:shadow-sm'}`}>
